        ...
        <div className="container mx-auto max-w-3xl text-center">
          ...
          <ScrollReveal direction="up" delay={0.4}>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <MagneticButton strength={0.3}>
                <button className="glass px-8 py-4 rounded-xl font-bold hover:border-primary transition-[background-color,border-color,color,transform,box-shadow] duration-200">
                  Descargar CV
                </button>
              </MagneticButton>
            </div>
