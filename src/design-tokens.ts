...
export const TYPOGRAPHY = {
  fontSize: {
    ...
    "2xl": "2.25rem", // 36px
    "3xl": "3rem", // 48px
    "4xl": "4rem", // 64px - Títulos grandes
    "5xl": "5rem", // 80px - Héroe gigante
    "6xl": "6rem", // 96px - Ultra grande
...
export const SHADOWS = {
  ...
  glow: "0 12px 32px rgba(37, 43, 37, 0.18)",
} as const;
...
export const ANIMATION = {
  duration: "0.6s", // Duración centralizada para todas las animaciones
  delay: {
    initial: 0.1, // Delay inicial en segundos
    stagger: 0.05, // Delay entre items consecutivos en segundos
  },
} as const;
